...
const Nosotros = () => {
    return (
        <div className="font-Roboto ">
            ...
            <div className="relative w-full h-40 flex items-center justify-center shadow-2xl shadow-black bg-[#ed2b2b] text-center text-white">
                <p className="text-[5vw] text-center  lg:text-4xl lg:px-64 ">Somos un restaurante que tiene como objetivo principal ofrecer sevicios alimenticios principalmente enfocandonos en la comida manaba a la ves que damos prioridad a nuestros distinguidos clientes</p>
            </div>
            <div className="my-20 md:my-40 pl-[20vw]  ">
                <div className="mb-6 " >
                    <h1 className="text-[7vw] md:text-5xl text-white">Te ayudamos con</h1>
                </div>
                <div className="text-[5vw] text-white md:text-2xl backdrop-blur-sm bg-[#ed2b2bb0]  border-2 border-[#ffffff80] rounded-l-2xl  py-20 ml-14 pl-10" data-aos="fade-right">
                    <p>El Sabor Manabita ofrece desayunos, almuerzos, encebollados </p>
                    <p>Variedad de platos típicos de la Costa Ecuatoriana</p>
                </div>
            </div>
