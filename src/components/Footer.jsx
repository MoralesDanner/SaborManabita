            ...
            <div className="grid grid-cols-1 md:grid-cols-3 w-full h-auto md:h-96 z-50 py-10">
                <div className="border-b-2 md:border-b-0 md:border-r-2 my-20 md:my-0 flex flex-col justify-center text-center ">
                    ...
                    <div className="flex justify-center ">
                        <div className="m-3">
                            <a href="https://www.facebook.com/profile.php?id=100037891976580" target="_blank" className="text-white"><img src={icono_facebook} alt="" className="w-[3vh] hover:w-[4vh]  transition-all duration-200"/></a>
                        </div> 
                ...
                <div className="flex flex-col justify-center text-center mb-20 md:mb-0">
                    ...
                    <div className="flex flex-col w-72  mx-auto ">
                        <div className="">
                            <a href="https://wa.me/593999163083" target="_blank" className="text-white hover:text-[#f5a02b] "><p><img src={icono_whatsapp} alt="" className="float-left" />0999163083</p></a>
                        </div>
                        <div className="">
                            <a href="mailto:sabormanabita1977@gmail.com" className="text-white hover:text-[#f5a02b] "><p><img src={icono_correo} alt="" className="float-left"/>sabormanabita1977@gmail.com</p></a>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col justify-center text-center mb-20 md:mb-0">
                    ...
                    <div className="flex justify-center">
                        <p><img src={icono_ubicacion} alt="" className="float-left "/>Latacunga - Vasconez Cuvi<br /> 
                        Galo Torres & Avenida Marco Aurelio Subia</p>
                    </div >           
                </div>
            </div>
            <div>
                <div className="flex justify-end">
                    <p><img src={icono_anited_blanco} alt="" className="float-left w-4 h-auto"/>Sabor Manabita, 2021 - todos los derechos reservados </p>
                </div >
            </div>
        </footer>
    )
